...
resolvidos = int(input(f"\nQuantos algoritmos foram resolvidos por sua equipe [{equipe1}]? "))
if resolvidos + 1:
    resolvidos1 += resolvidos
    pontuacao1 = resolvidos1 * 10
    print(f"A equipe {equipe1} resolveu {resolvidos1} algorítmos | Pontuação: {pontuacao1} ")
resolvidos = int(input(f"\nQuantos algoritmos foram resolvidos pela equipe adversária [{equipe2}]? "))
if resolvidos + 1:
    resolvidos2 += resolvidos
    pontuacao2 = resolvidos2 * 10
    print(f"A equipe {equipe2} resolveu {resolvidos2} algorítmos | Pontuação: {pontuacao2} ")

erros_enc = int(input(f"\nQuantos erros foram encontrados pela sua equipe [{equipe1}]? "))
if erros_enc1 + 1:
...
erros_enc = int(input(f"\nQuantos erros foram encontrados pela equipe adversária? [{equipe2}]? "))
if erros_enc + 1:
...
erros_cor = int(input(f"\nQuantos erros foram corrigidos pela sua equipe [{equipe1}]? "))
if erros_cor1 + 1:
...
erros_cor = int(input(f"\nQuantos erros foram corrigidos pela equipe adversária [{equipe2}]? "))
if erros_cor2 + 1:
...
horario1 = int(input(f"\nSua equipe [{equipe1}] atrasou a entrega dos algorítmos em quantos minutos? [Digite 0 para negar atraso] "))
...
horario2 = int(input(f"\nA equipe adversária [{equipe2}] atrasou a entrega dos algorítmos em quantos minutos? [Digite 0 para negar atraso] "))
